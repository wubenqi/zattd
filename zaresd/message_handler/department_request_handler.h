...
#ifndef ZARESD_MESSAGE_HANDLER_DEPARTMENT_REQUEST_HANDLER_H_
#define ZARESD_MESSAGE_HANDLER_DEPARTMENT_REQUEST_HANDLER_H_
...
private:
  DISALLOW_IMPLICIT_CONSTRUCTORS(DepartmentRequestHandler);
};
